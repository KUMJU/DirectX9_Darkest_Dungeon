...
_int CBrigandCutthroat::UpdateGameObject(const _float& fTimeDelta)
{
	...
	if (m_eCurAnimState != m_ePrevAnimState)
	{
		...
		case EAnimState::BESHOT:
			...
			m_pTransformCom->SetPosition(m_vPos.x, 2.f * 317.f / 311.f, m_vPos.z);
		...
		case EAnimState::SKILL1:
			...
			m_pTransformCom->SetPosition(m_vPos.x, 2.f * 268.f / 311.f, m_vPos.z);
		...
		case EAnimState::SKILL2:
			...
			m_pTransformCom->SetPosition(m_vPos.x, 2.f * 365.f / 311.f, m_vPos.z);
		...
		case EAnimState::CORPSE:
			...
			m_pTransformCom->SetPosition(m_vPos.x, 2.f * 158.f / 311.f, m_vPos.z);
			break;
