...
HRESULT CBrigandCutthroat::ReadyGameObject()
{
	...
	shared_ptr<CSkill> m_pBrigandCutthroat_1 = make_shared<CSkill>
		(L"Attack1", L"Brigand Cutthroat_Attack1", bTargetPos1, Skill1_Dot, 0.f, 1.2f, 1.5f,
	...
	shared_ptr<CSkill> m_pBrigandCutthroat_2 = make_shared<CSkill>
		(L"Attack2", L"Brigand Cutthroat_Attack2", bTargetPos2, Skill2_Dot, 0.f, 1.f, 1.2f,
...
_int CBrigandCutthroat::UpdateGameObject(const _float& fTimeDelta)
{
	...
	if (m_eCurAnimState != m_ePrevAnimState)
	{
		...
		case EAnimState::BESHOT:
			...
			m_pTransformCom->SetScale(2.5f * 225.f / 232.f, 2.5f * 317.f / 311.f, 1.f);
		...
		case EAnimState::SKILL1:
			...
			m_pTransformCom->SetScale(2.5f * 427.f / 232.f, 2.5f * 268.f / 311.f, 1.f);
		...
		case EAnimState::SKILL2:
			...
			m_pTransformCom->SetScale(2.5f * 232.f / 232.f, 2.5f * 365.f / 311.f, 1.f);
		...
		case EAnimState::CORPSE:
			...
			m_pTransformCom->SetScale(2.5f * 215.f / 232.f, 2.5f * 158.f / 311.f, 1.f);
