...
enum class CHANNELID {
	BGM, PLAYER, PLAYER_PROJ, STATUS, JESTER, VESTAL , SHIELDBREAKER , HIGHWAYMAN , MONSTER, BOSS, EFFECT, NARRATION,
	CURIO, DOOR, TRAP, OBSTACLE, INTERACTION, BOSS_PROJ1, BOSS_PROJ2,
	BOSS_PROJ3, BOSS_EFFECT, BOSS_HITTED, SPIKE, SUNKEN, MOB, ITEM, ENUM_END
};
