...
protected:
	...
	_float	m_fShootSpeed = 200.f;

	float	m_fAttackTime = 0.06f * 9;

	EMobBulletState m_eAnimState = EMobBulletState::IDLE;	// 애니메이션 변경을 위한 상태값
	EMobBulletState m_eCurAnimState = EMobBulletState::IDLE;	// 애니메이션 변경을 위한 상태값
